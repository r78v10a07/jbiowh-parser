 ...
 * @since Jul 5, 2011
 */
public class Gene2PMIDParser extends GeneCommon {
    ...
    public void loader() throws SQLException {
        ...
        checkOnlineData(GeneTables.getInstance().GENE2PMIDFILE, ".gz");
        ...
        whdbmsFactory.executeUpdate("TRUNCATE TABLE " + GeneTables.getInstance().GENE2PUBMEDTEMP);
        closeOnlineData(GeneTables.getInstance().GENE2PMIDFILE);
    }
}

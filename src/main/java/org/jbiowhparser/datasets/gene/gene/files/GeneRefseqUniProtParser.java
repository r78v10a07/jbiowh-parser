 ...
 * @since Jul 5, 2011
 */
public class GeneRefseqUniProtParser extends GeneCommon {
    ...
    public void loader() throws SQLException {
        ...
        checkOnlineData(GeneTables.getInstance().GENE_REFSEQ_UNIPROTKB_COLLAB, ".gz");
        ...
        whdbmsFactory.executeUpdate("TRUNCATE TABLE " + GeneTables.getInstance().GENE_REFSEQ_UNIPROTKB_COLLAB);
        closeOnlineData(GeneTables.getInstance().GENE_REFSEQ_UNIPROTKB_COLLAB);
    }
}
